 ...
 * @since 1.0.0
 */
public class ExcelLogFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelLogFunction INSTANCE = new ExcelLogFunction();
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("LOG", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
