 ...
 * @since 1.0.0
 */
public class ExcelAbsFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelAbsFunction INSTANCE = new ExcelAbsFunction();

    private ExcelAbsFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("ABS", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
