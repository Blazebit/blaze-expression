 ...
 * @since 1.0.0
 */
public class ExcelLowerFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelLowerFunction INSTANCE = new ExcelLowerFunction();

    private ExcelLowerFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("LOWER", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
