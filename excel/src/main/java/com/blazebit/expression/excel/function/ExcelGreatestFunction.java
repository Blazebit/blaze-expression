 ...
 * @since 1.0.0
 */
public class ExcelGreatestFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelGreatestFunction INSTANCE = new ExcelGreatestFunction();

    private ExcelGreatestFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("GREATEST", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
