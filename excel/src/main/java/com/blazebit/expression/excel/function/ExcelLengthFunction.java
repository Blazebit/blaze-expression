 ...
 * @since 1.0.0
 */
public class ExcelLengthFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelLengthFunction INSTANCE = new ExcelLengthFunction();

    private ExcelLengthFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("LENGTH",new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
