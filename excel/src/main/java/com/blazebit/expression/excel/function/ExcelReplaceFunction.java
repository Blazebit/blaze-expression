 ...
 * @since 1.0.0
 */
public class ExcelReplaceFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelReplaceFunction INSTANCE = new ExcelReplaceFunction();

    private ExcelReplaceFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("REPLACE", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
