 ...
 * @since 1.0.0
 */
public class ExcelCurrentTimeFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelCurrentTimeFunction INSTANCE = new ExcelCurrentTimeFunction();

    private ExcelCurrentTimeFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("CURRENT_TIME", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
    ...
    public void render(DomainFunction function, DomainType returnType, ExcelDomainFunctionArgumentRenderers argumentRenderers, StringBuilder sb, ExcelExpressionSerializer serializer) {
        sb.append("NOW()"); // TODO: this depends on the formatting
    }
}
