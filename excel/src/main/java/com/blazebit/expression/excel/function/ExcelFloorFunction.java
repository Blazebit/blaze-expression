 ...
 * @since 1.0.0
 */
public class ExcelFloorFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelFloorFunction INSTANCE = new ExcelFloorFunction();

    private ExcelFloorFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("FLOOR", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
