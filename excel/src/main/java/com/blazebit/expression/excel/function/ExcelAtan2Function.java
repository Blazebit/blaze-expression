 ...
 * @since 1.0.0
 */
public class ExcelAtan2Function implements ExcelFunctionRenderer, Serializable {

    private static final ExcelAtan2Function INSTANCE = new ExcelAtan2Function();

    private ExcelAtan2Function() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("ATAN2", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
