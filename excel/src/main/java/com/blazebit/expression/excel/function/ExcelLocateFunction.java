 ...
 * @since 1.0.0
 */
public class ExcelLocateFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelLocateFunction INSTANCE = new ExcelLocateFunction();

    private ExcelLocateFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("LOCATE", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
