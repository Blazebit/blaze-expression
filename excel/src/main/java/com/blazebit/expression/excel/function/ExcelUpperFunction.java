 ...
 * @since 1.0.0
 */
public class ExcelUpperFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelUpperFunction INSTANCE = new ExcelUpperFunction();

    private ExcelUpperFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("UPPER", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
