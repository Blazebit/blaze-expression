 ...
 * @since 1.0.0
 */
public class ExcelRTrimFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelRTrimFunction INSTANCE = new ExcelRTrimFunction();

    private ExcelRTrimFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("RTRIM", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
    ...
    public void render(DomainFunction function, DomainType returnType, ExcelDomainFunctionArgumentRenderers argumentRenderers, StringBuilder sb, ExcelExpressionSerializer serializer) {
        ...
        if (argumentRenderers.assignedArguments() != 1) {
            ...
            sb.append("MID(");
            argumentRenderers.renderArgument(sb, 0);
            sb.append(separator).append(" 1").append(separator).append(" FIND(LEFT(TRIM(");
            argumentRenderers.renderArgument(sb, 0);
