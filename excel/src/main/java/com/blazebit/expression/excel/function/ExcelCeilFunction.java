 ...
 * @since 1.0.0
 */
public class ExcelCeilFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelCeilFunction INSTANCE = new ExcelCeilFunction();

    private ExcelCeilFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("CEIL", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
