 ...
 * @since 1.0.0
 */
class ExcelStringlyTypeConstructorFunctionRenderer implements ExcelFunctionRenderer, Serializable {
     ...
     */
    public ExcelStringlyTypeConstructorFunctionRenderer(ExcelStringlyTypeHandler stringlyTypeHandler) {
    ...
    public void render(DomainFunction function, DomainType returnType, ExcelDomainFunctionArgumentRenderers argumentRenderers, StringBuilder sb, ExcelExpressionSerializer serializer) {
        stringlyTypeHandler.appendExcelConstructTo(sb, subBuilder -> argumentRenderers.renderArgument(subBuilder, 0));
    }
}
