 ...
 * @since 1.0.0
 */
public class ExcelEndsWithFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelEndsWithFunction INSTANCE = new ExcelEndsWithFunction();

    private ExcelEndsWithFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("ENDS_WITH", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
    ...
    public void render(DomainFunction function, DomainType returnType, ExcelDomainFunctionArgumentRenderers argumentRenderers, StringBuilder sb, ExcelExpressionSerializer serializer) {
        ...
        sb.append(serializer.getArgumentSeparator()).append(" LEN(");
