 ...
 * @since 1.0.0
 */
public class ExcelSizeFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelSizeFunction INSTANCE = new ExcelSizeFunction();

    private ExcelSizeFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("SIZE", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
