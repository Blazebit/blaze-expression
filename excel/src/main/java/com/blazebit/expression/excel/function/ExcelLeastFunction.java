 ...
 * @since 1.0.0
 */
public class ExcelLeastFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelLeastFunction INSTANCE = new ExcelLeastFunction();

    private ExcelLeastFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("LEAST", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
