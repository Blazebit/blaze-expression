 ...
 * @since 1.0.0
 */
public class ExcelCurrentTimestampFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelCurrentTimestampFunction INSTANCE = new ExcelCurrentTimestampFunction();

    private ExcelCurrentTimestampFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("CURRENT_TIMESTAMP", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
