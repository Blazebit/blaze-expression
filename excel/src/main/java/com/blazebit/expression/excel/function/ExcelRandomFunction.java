 ...
 * @since 1.0.0
 */
public class ExcelRandomFunction implements ExcelFunctionRenderer, Serializable {

    private static final ExcelRandomFunction INSTANCE = new ExcelRandomFunction();

    private ExcelRandomFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("RANDOM", new ExcelFunctionRendererMetadataDefinition(INSTANCE));
    }
