 ...
 * @since 1.0.0
 */
public interface DomainFunctionArgumentRenderers {

    /**
     * Empty arguments.
     */
    DomainFunctionArgumentRenderers EMPTY = new DomainFunctionArgumentRenderers() {
        @Override
     ...
     * @param position The position
     */
    void renderArgument(StringBuilder sb, int position);
