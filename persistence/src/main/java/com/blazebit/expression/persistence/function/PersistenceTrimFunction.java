 ...
 * @since 1.0.0
 */
public class PersistenceTrimFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceTrimFunction INSTANCE = new PersistenceTrimFunction();

    private PersistenceTrimFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("TRIM", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
