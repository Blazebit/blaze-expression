 ...
 * @since 1.0.0
 */
public class IntervalOperatorHandler implements ComparisonOperatorInterpreter, DomainOperatorInterpreter, DomainOperatorRenderer, Serializable {

    public static final IntervalOperatorHandler INSTANCE = new IntervalOperatorHandler();

    private IntervalOperatorHandler() {
    }
