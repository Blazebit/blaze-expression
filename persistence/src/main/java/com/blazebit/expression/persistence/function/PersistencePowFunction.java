 ...
 * @since 1.0.0
 */
public class PersistencePowFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistencePowFunction INSTANCE = new PersistencePowFunction();

    private PersistencePowFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("POW", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
