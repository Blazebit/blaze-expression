 ...
 * @since 1.0.0
 */
public class PersistenceGreatestFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceGreatestFunction INSTANCE = new PersistenceGreatestFunction();

    private PersistenceGreatestFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("GREATEST", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
