 ...
 * @since 1.0.0
 */
public class PersistenceCeilFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceCeilFunction INSTANCE = new PersistenceCeilFunction();

    private PersistenceCeilFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("CEIL", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
