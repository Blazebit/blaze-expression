 ...
 * @since 1.0.0
 */
public class PersistenceLowerFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceLowerFunction INSTANCE = new PersistenceLowerFunction();

    private PersistenceLowerFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("LOWER", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
