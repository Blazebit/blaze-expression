 ...
 * @since 1.0.0
 */
public class PersistenceRTrimFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceRTrimFunction INSTANCE = new PersistenceRTrimFunction();

    private PersistenceRTrimFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("RTRIM", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
