 ...
 * @since 1.0.0
 */
class PersistenceStringlyTypeDestructorFunctionRenderer implements PersistenceFunctionRenderer, Serializable {
     ...
     */
    public PersistenceStringlyTypeDestructorFunctionRenderer(PersistenceStringlyTypeHandler stringlyTypeHandler) {
    ...
    public void render(DomainFunction function, DomainType returnType, PersistenceDomainFunctionArgumentRenderers argumentRenderers, StringBuilder sb, PersistenceExpressionSerializer serializer) {
        stringlyTypeHandler.appendPersistenceDestructTo(sb, subBuilder -> argumentRenderers.renderArgument(subBuilder, 0));
    }
}
