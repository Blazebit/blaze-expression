 ...
 * @since 1.0.0
 */
public class PersistenceUpperFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceUpperFunction INSTANCE = new PersistenceUpperFunction();

    private PersistenceUpperFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("UPPER", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
