...
public interface PersistenceDomainOperatorRenderer {
     ...
     */
    boolean render(ChainingArithmeticExpression expression, PersistenceExpressionSerializer serializer);
     ...
     * @since 1.0.0
     */
    class SimpleDomainOperatorRenderer implements PersistenceDomainOperatorRenderer, Serializable {
        @Override
