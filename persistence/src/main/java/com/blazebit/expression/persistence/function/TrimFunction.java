 ...
 * @since 1.0.0
 */
public class TrimFunction implements FunctionRenderer, FunctionInvoker, Serializable {
    ...
    public static void addFunction(DomainBuilder domainBuilder, ClassLoader classLoader) {
        domainBuilder.createFunction("TRIM")
                ...
                .withArgument("string", STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("TRIM_STRING", classLoader))
                .withArgument("character", STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("TRIM_CHARACTER", classLoader))
                .build();
    }
