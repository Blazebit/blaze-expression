 ...
 * @since 1.0.0
 */
public class PersistenceLengthFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceLengthFunction INSTANCE = new PersistenceLengthFunction();

    private PersistenceLengthFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("LENGTH",new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
