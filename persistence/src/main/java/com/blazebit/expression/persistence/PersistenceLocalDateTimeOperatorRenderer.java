...
public class PersistenceLocalDateTimeOperatorRenderer implements PersistenceDomainOperatorRenderer, Serializable {

    public static final PersistenceLocalDateTimeOperatorRenderer INSTANCE = new PersistenceLocalDateTimeOperatorRenderer();

    private PersistenceLocalDateTimeOperatorRenderer() {
    }
