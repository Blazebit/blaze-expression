 ...
 * @since 1.0.0
 */
public class PersistenceSizeFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceSizeFunction INSTANCE = new PersistenceSizeFunction();

    private PersistenceSizeFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("SIZE", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
