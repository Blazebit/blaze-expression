 ...
 * @since 1.0.0
 */
public class PersistenceAbsFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceAbsFunction INSTANCE = new PersistenceAbsFunction();

    private PersistenceAbsFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("ABS", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
