 ...
 * @since 1.0.0
 */
public class PersistenceLocateFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceLocateFunction INSTANCE = new PersistenceLocateFunction();

    private PersistenceLocateFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("LOCATE", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
