 ...
 * @since 1.0.0
 */
public class PersistenceAtan2Function implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceAtan2Function INSTANCE = new PersistenceAtan2Function();

    private PersistenceAtan2Function() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("ATAN2", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
