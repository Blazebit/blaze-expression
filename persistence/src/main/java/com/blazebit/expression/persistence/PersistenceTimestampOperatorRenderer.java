 ...
 * @since 1.0.0
 */
public class PersistenceTimestampOperatorRenderer implements PersistenceDomainOperatorRenderer, Serializable {

    public static final PersistenceTimestampOperatorRenderer INSTANCE = new PersistenceTimestampOperatorRenderer();

    private PersistenceTimestampOperatorRenderer() {
    }
