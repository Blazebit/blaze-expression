 ...
 * @since 1.0.0
 */
public class PersistenceCurrentDateFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceCurrentDateFunction INSTANCE = new PersistenceCurrentDateFunction();

    private PersistenceCurrentDateFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("CURRENT_DATE", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
