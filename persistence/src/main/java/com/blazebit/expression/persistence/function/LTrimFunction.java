...
public class LTrimFunction implements FunctionRenderer, FunctionInvoker, Serializable {
    ...
    public static void addFunction(DomainBuilder domainBuilder, ClassLoader classLoader) {
        domainBuilder.createFunction("LTRIM")
                ...
                .withArgument("string", STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("LTRIM_STRING", classLoader))
                .withArgument("character", STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("LTRIM_CHARACTER", classLoader))
                .build();
    }
