 ...
 * @since 1.0.0
 */
public class PersistenceRoundFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceRoundFunction INSTANCE = new PersistenceRoundFunction();

    private PersistenceRoundFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("ROUND", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
