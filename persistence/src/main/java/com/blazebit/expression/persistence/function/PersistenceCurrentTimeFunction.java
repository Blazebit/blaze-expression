 ...
 * @since 1.0.0
 */
public class PersistenceCurrentTimeFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceCurrentTimeFunction INSTANCE = new PersistenceCurrentTimeFunction();

    private PersistenceCurrentTimeFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("CURRENT_TIME", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
