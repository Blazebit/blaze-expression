 ...
 * @since 1.0.0
 */
public class PersistenceRandomFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceRandomFunction INSTANCE = new PersistenceRandomFunction();

    private PersistenceRandomFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("RANDOM", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
