 ...
 * @since 1.0.0
 */
public class PersistenceFloorFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceFloorFunction INSTANCE = new PersistenceFloorFunction();

    private PersistenceFloorFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("FLOOR", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
