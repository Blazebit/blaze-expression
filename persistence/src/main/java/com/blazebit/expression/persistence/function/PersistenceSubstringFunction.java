 ...
 * @since 1.0.0
 */
public class PersistenceSubstringFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceSubstringFunction INSTANCE = new PersistenceSubstringFunction();

    private PersistenceSubstringFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("SUBSTRING", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
