 ...
 * @since 1.0.0
 */
public class PersistenceReplaceFunction implements PersistenceFunctionRenderer, Serializable {

    private static final PersistenceReplaceFunction INSTANCE = new PersistenceReplaceFunction();

    private PersistenceReplaceFunction() {
    }
    ...
    public static void addFunction(DomainBuilder domainBuilder) {
        domainBuilder.extendFunction("REPLACE", new PersistenceFunctionRendererMetadataDefinition(INSTANCE));
    }
