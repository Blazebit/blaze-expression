...
public class PersistenceSubqueryCorrelationRenderer implements PersistenceCorrelationRenderer, MetadataDefinition<PersistenceCorrelationRenderer>, Serializable {
    ...
    public String correlate(CriteriaBuilder<?> cb, String parentAlias, PersistenceExpressionSerializer serializer) {
        ...
        String alias = serializer.registerSubqueryProvider(new PersistenceSubqueryProviderWrapper(embeddingViewJpqlMacro, parentAlias, subqueryAttribute.getSubqueryProviderFactory().create(null, Collections.emptyMap())));
    ...
    private static final class PersistenceSubqueryProviderWrapper implements PersistenceSubqueryProvider {
         ...
         */
        public PersistenceSubqueryProviderWrapper(MutableEmbeddingViewJpqlMacro embeddingViewJpqlMacro, String embeddingViewPath, com.blazebit.persistence.view.SubqueryProvider subqueryProvider) {
