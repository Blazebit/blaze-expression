 ...
 * @since 1.0.0
 */
public class PersistenceCorrelationProviderCorrelationRenderer implements PersistenceCorrelationRenderer, MetadataDefinition<PersistenceCorrelationRenderer>, Serializable {
     ...
     */
    public PersistenceCorrelationProviderCorrelationRenderer(CorrelatedAttribute<?, ?> correlatedAttribute) {
