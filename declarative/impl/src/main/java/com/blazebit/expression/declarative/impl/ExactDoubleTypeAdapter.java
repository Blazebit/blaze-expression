 ...
 * @since 1.0.0
 */
public class ExactDoubleTypeAdapter implements TypeAdapter<Double, BigDecimal>, Serializable {

    public static final ExactDoubleTypeAdapter INSTANCE = new ExactDoubleTypeAdapter();

    private ExactDoubleTypeAdapter() {
    }
