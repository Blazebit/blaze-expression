 ...
 * @since 1.0.0
 */
public class ExactFloatTypeAdapter implements TypeAdapter<Float, BigDecimal>, Serializable {

    public static final ExactFloatTypeAdapter INSTANCE = new ExactFloatTypeAdapter();

    private ExactFloatTypeAdapter() {
    }
