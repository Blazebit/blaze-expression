 ...
 * @since 1.0.0
 */
public class ExactShortTypeAdapter implements TypeAdapter<Short, BigInteger>, Serializable {

    public static final ExactShortTypeAdapter INSTANCE = new ExactShortTypeAdapter();

    private ExactShortTypeAdapter() {
    }
