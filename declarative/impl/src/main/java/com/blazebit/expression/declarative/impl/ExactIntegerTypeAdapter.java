 ...
 * @since 1.0.0
 */
public class ExactIntegerTypeAdapter implements TypeAdapter<Integer, BigInteger>, Serializable {

    public static final ExactIntegerTypeAdapter INSTANCE = new ExactIntegerTypeAdapter();

    private ExactIntegerTypeAdapter() {
    }
