 ...
 * @since 1.0.0
 */
public class ExactByteTypeAdapter implements TypeAdapter<Byte, BigInteger>, Serializable {

    public static final ExactByteTypeAdapter INSTANCE = new ExactByteTypeAdapter();

    private ExactByteTypeAdapter() {
    }
