...
public class ApproximateShortTypeAdapter implements TypeAdapter<Short, Long>, Serializable {
    ...
    @Override
    public Long toInternalType(ExpressionInterpreter.Context context, Short value, DomainType domainType) {
        if (value == null) {
            return null;
        }
    ...
    @Override
    public Short toModelType(ExpressionInterpreter.Context context, Long value, DomainType domainType) {
        if (value == null) {
            return null;
        }
