 ...
 * @since 1.0.0
 */
public class SubstringFunction implements FunctionInvoker, Serializable {
    ...
    public static void addFunction(DomainBuilder domainBuilder, ClassLoader classLoader) {
        domainBuilder.createFunction("SUBSTRING")
                ...
                .withArgument("string", BaseContributor.STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("SUBSTRING_STRING", classLoader))
                .withArgument("start", BaseContributor.INTEGER_TYPE_NAME, DocumentationMetadataDefinition.localized("SUBSTRING_START", classLoader))
                .withArgument("count", BaseContributor.INTEGER_TYPE_NAME, DocumentationMetadataDefinition.localized("SUBSTRING_COUNT", classLoader))
                .build();
    }
