 ...
 * @since 1.0.0
 */
public class UpperFunction implements FunctionInvoker, Serializable {
    ...
    public static void addFunction(DomainBuilder domainBuilder, ClassLoader classLoader) {
        domainBuilder.createFunction("UPPER")
                ...
                .withArgument("string", BaseContributor.STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("UPPER_STRING", classLoader))
                .build();
    }
