 ...
 * @since 1.0.0
 */
public class TrimFunction implements FunctionInvoker, Serializable {
    ...
    public static void addFunction(DomainBuilder domainBuilder, ClassLoader classLoader) {
        domainBuilder.createFunction("TRIM")
                ...
                .withArgument("string", BaseContributor.STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("TRIM_STRING", classLoader))
                .withArgument("character", BaseContributor.STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("TRIM_CHARACTER", classLoader))
                .build();
    }
