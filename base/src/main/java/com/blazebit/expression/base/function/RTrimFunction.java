 ...
 * @since 1.0.0
 */
public class RTrimFunction implements FunctionInvoker, Serializable {
    ...
    public static void addFunction(DomainBuilder domainBuilder, ClassLoader classLoader) {
        domainBuilder.createFunction("RTRIM")
                ...
                .withArgument("string", BaseContributor.STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("RTRIM_STRING", classLoader))
                .withArgument("character", BaseContributor.STRING_TYPE_NAME, DocumentationMetadataDefinition.localized("RTRIM_CHARACTER", classLoader))
                .build();
    }
